 ...
 */
public class GeradorCoresUtil implements Serializable {

    private static final long serialVersionUID = 1L;

    /**
     * Método responsável pela geração de cores em hexadecimal
     *
     * @return A cor
     */
    ...
    /**
     * Método responsável por tratar a string hexadecimal. Caso a string possua
     * tamanho 1, o método adiciona o número 0 na frente da string.
     *
    ...
    /**
     * Método que trata o brilho de uma cor. Para que uma cor seja escolhida
     * para o gráfico seu nível de brilho deve estar acima ou igual de 0.5 e
     * abaixo ou igual de 0.9.
     *
     * @param brightness Representa o brilho.
     * @return Retorna true caso a cor esteja de acordo com o ponto necessário
     * (brilho), false caso contrário.
     */
    ...
    /**
     * Método que trata a saturação de uma cor. Para que uma cor seja escolhida
     * para o gráfico seu nível de saturação deve estar acima ou igual de 0.7.
     *
     * @param saturation Representa a saturação
     * @return Retorna true caso a cor esteja de acordo com o ponto necessário
     * (saturação), false caso contrário.
     */
    ...
    /**
     * Método que avalia se a distância entre duas é aceitável. Uma distância é
     * dita aceita se é menor que 200.
     *
     * @param cor1 Representa uma cor.
     * @param cor2 Representa uma cor.
     * @return boolean Retorna true caso a distância seja menor que 200, false
     * caso contrário.
     */
    ...
    /**
     * Método que valida se uma cor gerada aleatoriamente possui uma distância
     * aceitável com as cores previamente permitidas.
     *
     * @param coresPermitidas Representa as cores permitidas.
     * @param corAleatoria Representa a cor gerada aleatoriamente.
     * @return Retorna true caso a cor seja parecida, retorna false caso
     * contrário.
     */
    ...
    /**
     * Método responsável por gerar cores aleatoriamente no formato RGB seguindo
     * os padrões de qualidade especificados.
     *
     * @param qtdDeCores Representa a quantidade de cores que deseja-se gerar.
     * @return List<Color> Representa a lista de cores permitidas em formato
     * RGB.
     */
